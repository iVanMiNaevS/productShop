		...
		<MainLayout>
			<div className="container">
				<div className={styles.product}>
					<img className={styles.product_img} src={product.poster.url} alt={product.title} />
...
export const getServerSideProps = async (context: any) => {
	...
	const res = await fetch(`${STRAPI_URL}/api/products?filters[slug][$eq]=${slug}&populate=poster`);
	const data = await res.json();
	return {
		props: {
			product: data.data?.[0]
